    ...
    multipleChoice: [
        {
            ...
            answer: 0,
            aiResponses: [
                "Correct! Gustatio was usually a salad or small meat dish such as clams, sea urchins, or lightly salted snails. [Roman Food, pg. 2]",
        ...
        },
        {
            ...
            aiResponses: [
                ...
                "Correct! Muslum was wine mixed with honey and was associated with the starter [Roman Food, pg. 2].",
        ...
        },
        {
            ...
            aiResponses: [
                ...
                "Correct! Goatfish was considered a luxury dish [Roman Food, pg. 3].",
        ...
        },
        {
            ...
            aiResponses: [
                ...
                "Correct! Garum was a spread or sauce made from fish intestines [Roman Food, pg. 3].",
        ...
        },
        {
            ...
            answer: 0,
            aiResponses: [
                "Correct! Pottage was a simple stew made from grains like wheat, millet, or corn [Roman Food, pg. 5].",
    ...
    freeResponse: [
        {
            ...
            aiResponse: "A strong answer would mention that the gustatio was usually a salad or small meat dish—such as clams, sea urchins, or lightly salted snails—often served with muslum, a drink made from wine and honey [Roman Food, pg. 2]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "Pottage was a simple everyday stew made from grains such as wheat, millet, or corn, often mixed with home-grown vegetables. It was one of the most common household foods for ordinary Romans [Roman Food, pg. 5]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "Breakfast was typically bread and fresh fruit. Lunch could include small amounts of cooked meat like ham or salami, cheese, eggs, vegetables, and bread. Dinner—the main meal—often began with a salad or small meat dish [Roman Food, pg. 6]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "Romans enjoyed many fruits such as grapes, figs, dates, and mulberries, as well as nuts like walnuts, hazelnuts, almonds, and pine nuts. They also ate cakes soaked in honey, fruit tarts, and sweet buns [Roman Food, pg. 4]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "Romans drank wine that was usually watered down, sometimes heated or spiced. Lower classes often drank pasca—a watered-down wine or vinegar drink. Beer and mead were common in northern towns. Milk was considered barbaric and mostly used for cheese-making [Roman Food, pg. 9]."
        }
    ],
    ...
    trueFalse: [
        {
            ...
            answer: "false",
            aiResponse: "False. Romans actually thought it was crazy to drink undiluted wine and typically watered it down [Roman Food, pg. 9, 11]."
        },
        {
            type: "true-false",
            question: "Goatfish was considered a luxury item in Roman main dishes.",
            answer: "true",
            aiResponse: "True. Goatfish is specifically mentioned as a luxury food [Roman Food, pg. 2]."
        },
        {
            type: "true-false",
            question: "A typical Roman breakfast might include bread and fresh fruit.",
            answer: "true",
            aiResponse: "True. The text describes breakfast as bread and fresh fruit eaten early in the day [Roman Food, pg. 6]."
        },
        {
            type: "true-false",
            question: "Milk was a popular Roman drink at the dinner table and was served to guests.",
            answer: "false",
            aiResponse: "False. Milk was considered barbaric and mainly reserved for making cheese [Roman Food, pg. 9]."
        },
        {
            type: "true-false",
            question: "Romans sometimes ate snails, including snails soaked in milk.",
            answer: "true",
            aiResponse: "True. Snails appear as a starter and one fact mentions snails soaked in milk [Roman Food, pg. 11]."
        }
    ],
    ...
    sentenceCompletion: [
        {
            ...
            answer: "gustatio",
            aiResponse: "The correct term is 'gustatio', referring to the starter course of the meal [Roman Food, pg. 3]."
        },
        {
            type: "sentence-completion",
            question: "An everyday stew made from wheat, millet, or corn was called ________.",
            answer: "pottage",
            aiResponse: "This common home dish was called 'pottage' [Roman Food, pg. 5]."
        },
        {
            type: "sentence-completion",
            question: "Romans often ate their main dish with bread and a fish-intestine sauce called ________.",
            answer: "garum",
            aiResponse: "The salty fish-intestine sauce was called 'garum' [Roman Food, pg. 3]."
        },
        {
            type: "sentence-completion",
            question: "After the main course, an offering was made to the spirit of the ________.",
            answer: "house",
            aiResponse: "The offering was made to the spirit of the house, using meat, wine, and cake [Roman Food, pg. 8]."
        },
        {
            type: "sentence-completion",
            question: "Among lower classes, a drink made from watering down wine or vinegar was known as ________.",
            answer: "Pasca",
            aiResponse: "The text refers to this drink as 'Pasca' [Roman Food, pg. 9]."
        }
    ],
    ...
    selection: [
        {
            ...
            answers: [0, 1, 3, 4, 5, 6],
            aiResponses: [
                "✅ Wheat or barley were central grains in their diet [Roman Food, pg. 5-6].",
                "✅ Olive oil was a staple ingredient [Roman Food, pg. 5-6].",
                "❌ The text emphasizes simple foods, not lots of beef and pork every day.",
                "✅ Home-grown vegetables were commonly eaten [Roman Food, pg. 5-6].",
                "✅ Chicken and cheese are both mentioned as part of typical food [Roman Food, pg. 5-6].",
                "✅ They ate a few eggs, not huge quantities [Roman Food, pg. 5-6].",
                "✅ Wine was part of their usual consumption [Roman Food, pg. 5-6].",
        ...
        },
        {
            ...
            answers: [0, 1, 3, 4, 5],
            aiResponses: [
                "✅ Grapes were one of the most popular desserts [Roman Food, pg. 4].",
                "✅ Figs are listed as a dessert fruit [Roman Food, pg. 4].",
                "❌ Hamburgers are not a Roman dessert in the text.",
                "✅ Fruit tarts are mentioned as a sweet food [Roman Food, pg. 4].",
                "✅ Sweet buns were also eaten as desserts [Roman Food, pg. 4].",
                "✅ Mulberries are included among the fruits they enjoyed [Roman Food, pg. 4]."
            ]
        },
        {
            type: "select-all",
            ...
            answers: [0, 1, 2, 3],
            aiResponses: [
                "✅ Musicians are specifically mentioned as part of dinner entertainment [Roman Food, pg. 8].",
                "✅ Acrobats performed for guests during dinners [Roman Food, pg. 8].",
                "✅ Poets could perform during the meal [Roman Food, pg. 8].",
                "✅ Dancers are also listed as entertainment [Roman Food, pg. 8].",
